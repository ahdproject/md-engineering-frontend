...
export default function Dashboard() {
  ...
  const welcomeCard = theme === 'blue-beige' 
    ? 'bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg'
    : 'bg-black rounded-2xl p-6 text-white';

  const tableHeaderBg = theme === 'blue-beige'
    ? 'bg-amber-50'
    : 'bg-gray-100';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className={welcomeCard}>
        ...
        <p className={theme === 'blue-beige' ? 'text-blue-100 text-sm mt-1 capitalize' : 'text-gray-400 text-sm mt-1 capitalize'}>{user?.role} · M&D Engineers Private Limited</p>
      </div>
